...
ApplicationWindow {
    ...
    ListModel {
        ...
        ListElement { tag: "C:/image2";dirName:"图片目录2" }
        ListElement { tag: "C:/image3";dirName:"图片目录3" }
        ListElement { tag: "D:/Qt-Demo/DriverQtVersion/images";dirName:"图片目录4" }
        ListElement { tag: "E:/MyPersional/persional";dirName:"图片目录5" }
    }
